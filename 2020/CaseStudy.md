...
[CYBERer.NET: R - 入門本編 4章 順序付き因子と順序無し因子](https://www.cyberer.net/2020/08/r-ordered-and-unordered-factors.html)
...
2012-09-21 Rプログラム (TAKENAKA's Web Page) [リストにオブジェクトをしまう](http://takenaka-akio.org/doc/r_auto/list.html)
